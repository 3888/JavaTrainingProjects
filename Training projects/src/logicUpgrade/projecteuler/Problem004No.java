package logicUpgrade.projecteuler;
...
//
//    створи метод в €кому будеш перевертати р€док
//    ц≥лочисленним д≥ленн€м
//
...
//                1) пришел палиндром
//                2) его сохран€ю в переменную
//                3) тупик, перменна€ перезаписываетс€ и сравнить не счем

//                перезаписуй лише €щко б≥льша за попередн≥й пал≥ндро
//                ≥ пот≥м наступн≥ пор≥внюй
