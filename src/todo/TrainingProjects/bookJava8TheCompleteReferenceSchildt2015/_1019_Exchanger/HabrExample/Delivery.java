package todo.TrainingProjects.bookJava8TheCompleteReferenceSchildt2015._1019_Exchanger.HabrExample;
...
public class Delivery {
    ...
    public static class Truck implements Runnable {
        ...
        public Truck(int truckNumber, String departure, String destination, String[] parcels) {
            this.number = truckNumber;
            this.dep = departure;
        ...
        public void run() {
            try {
                ...
                System.out.printf("В грузовик №%d переместили " + parcels[1] + " для пункта %s.\n", number, dest);
                Thread.sleep(1000 + (long) Math.random() * 5000);
