package todo.TrainingProjects.bookJava8TheCompleteReferenceSchildt2015._1014_SemaphoreConsumerExample.HabrExample;
        ...
        public void run() {
            ...
            try {
                ...
                synchronized (PARKING_PLACES) {
                    for (int i = 0; i < 5; i++)
                        if (!PARKING_PLACES[i]) {      //Если место свободно (по умолчанию false)
                ...
                synchronized (PARKING_PLACES) {
                    ...
                    System.out.printf("Автомобиль №%d освобождает место.\n", carNumber);
                }
