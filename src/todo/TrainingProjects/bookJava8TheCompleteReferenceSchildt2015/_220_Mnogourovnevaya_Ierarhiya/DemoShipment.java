package todo.TrainingProjects.bookJava8TheCompleteReferenceSchildt2015._220_Mnogourovnevaya_Ierarhiya;
...
public class DemoShipment {
    ...
    public static void main(String args[]) {
        ...
        System.out.println("Bee shipmentl равен "
                + shipmentl.weight);
        System.out.println("Стоимость доставки: $" + shipmentl.cost);
        System.out.println();
