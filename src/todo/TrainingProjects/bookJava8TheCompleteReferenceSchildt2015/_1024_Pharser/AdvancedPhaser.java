package todo.TrainingProjects.bookJava8TheCompleteReferenceSchildt2015._1024_Pharser;

import java.util.concurrent.Phaser;

public class AdvancedPhaser extends Phaser {
    int numPhases;
...
class PhaserAdvancedDemo {
    public static void main(String args[]) {
        AdvancedPhaser phsr = new AdvancedPhaser(1, 3);
