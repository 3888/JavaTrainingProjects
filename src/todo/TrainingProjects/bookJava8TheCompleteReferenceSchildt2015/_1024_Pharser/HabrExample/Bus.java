package todo.TrainingProjects.bookJava8TheCompleteReferenceSchildt2015._1024_Pharser.HabrExample;
...
public class Bus {
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        for (int i = 1; i < 5; i++) {           //Сгенерируем пассажиров на остановках
            ...
            passengers.add(new Passenger(i, i + 2));//Этот пассажир выходит через одну
    ...
    public static class Passenger extends Thread {
        ...
        public String toString() {
            return "Пассажир маршрута {" + departure + " -> " + destination + '}';
        }
    }
}
